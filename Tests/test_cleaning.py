...
# load cleaned data
# load cleaned data
df = pd.read_csv(r'C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\cleaned\cleaned_data.csv')
sensors = pd.read_csv(r'C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\cleaned\sensor_master_cleaned.csv')
manual = pd.read_csv(r"C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\cleaned\manual_cleaned.csv")
threshold = pd.read_csv(r"C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\cleaned\thresholds_cleaned.csv")
maint = pd.read_csv(r"C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\cleaned\maintenance_cleaned.csv")
audit_df = pd.read_csv(r"C:\Users\JyothsnaSatish\OneDrive\Desktop\CASE_STUDY\notebooks\cleaning_log.csv")
...
def test_r10_maintenance():
    ...
    count = df.loc[maint_mask, ['PM2.5','SO2','NOx']].notna().sum().sum()
    
    print(f"⚠️ R10: Maintenance rows contain values — {count} (allowed)")
